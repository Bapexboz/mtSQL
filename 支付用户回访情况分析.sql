...
where datekey between 20170701 and 20170731)y
...
join ba_travel.topic_order_date c on a.uuid=c.uuid and c.datekey between 20170701 and 20170731
and a.datekey between 20170701 and 20170731 )x  on x.user_id = y.user_id 
...
from ba_travel.fact_mt_sale_platform_domestic_new_pay_user
where datekey between 20170701 and 20170731
group by datekey)bb 
